...
class Attention(nn.Module):
    ...
    def gradient(self, k, v, w1, w2):
        """
        手工前向 + 手工反向并更新 W1,W2（in-place update，no autograd）
        假设 V 是 one-hot 或概率分布，形状 [B,H,N,C].
        Inputs:
            K: [B,H,N,C]  输入
            V: [B,H,N,C]  目标分布 (one-hot 或概率)
            W1: [B,H,C,D]
            W2: [B,H,D,C]
            lr: float 学习率
        Returns:
            loss_per_mlp: [B,H] 每个 mlp 的交叉熵损失标量
        """
        # -------- 正向 --------
        # z: [B,H,N,D]
        z = k @ w1
        sig = F.sigmoid(z)  # [B,H,N,D]
        s = z * sig  # [B,H,N,D]
        # y = s @ w2

        # -------- 反向（手工展开） --------
        e =  - v / float(v.shape[2]) * self.scale  # [B,H,N,C]
...
@register_model
def draft_deit_tiny(pretrained=False, **kwargs):
...
@register_model
def draft_deit_small(pretrained=False, **kwargs):
...
@register_model
def draft_deit_small_b12(pretrained=False, **kwargs):
    """ DeiT-small model @ 224x224 from paper (https://arxiv.org/abs/2012.12877).
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
...
@register_model
def draft_deit_small_b48(pretrained=False, **kwargs):
    """ DeiT-small model @ 224x224 from paper (https://arxiv.org/abs/2012.12877).
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
...
@register_model
def draft_deit_small_l1(pretrained=False, **kwargs):
    """ DeiT-small model @ 224x224 from paper (https://arxiv.org/abs/2012.12877).
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
...
@register_model
def draft_deit_small_l2(pretrained=False, **kwargs):
    """ DeiT-small model @ 224x224 from paper (https://arxiv.org/abs/2012.12877).
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
...
@register_model
def draft_deit_small_l4(pretrained=False, **kwargs):
    """ DeiT-small model @ 224x224 from paper (https://arxiv.org/abs/2012.12877).
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
...
@register_model
def draft_deit_small_l5(pretrained=False, **kwargs):
    """ DeiT-small model @ 224x224 from paper (https://arxiv.org/abs/2012.12877).
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
...
@register_model
def draft_deit_base(pretrained=False, **kwargs):
